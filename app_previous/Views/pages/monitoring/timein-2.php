...
<body class="bg-gray-50 min-h-screen">
    <main class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="max-w-4xl mx-auto">
            <div>
                <div
                    class="bg-gradient-to-br from-white to-blue-50/20 rounded-3xl shadow-2xl border-0 overflow-hidden backdrop-blur-sm">
                    <div
                        class="bg-gradient-to-r from-indigo-500/10 via-purple-500/5 to-pink-500/10 px-8 py-8 border-b border-gray-100/30">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-5">
                                <div
                                    class="w-20 h-20 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl flex items-center justify-center shadow-2xl">
                            ...
                            <div class="text-right">
                                <div
                                    class="flex items-center space-x-4 px-6 py-3 bg-white/80 backdrop-blur-md rounded-2xl shadow-lg border border-white/20">
                                    <div
                                        class="w-4 h-4 bg-red-500 rounded-full pulse-animation shadow-lg"
                                        id="statusIndicator"></div>
                                    <span
                                        class="text-base font-bold text-gray-800"
                                        id="statusText">Not Clocked In</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="p-8">
                        <div
                            class="text-center mb-12 bg-gradient-to-br from-gray-50 to-blue-50/30 rounded-3xl py-12 px-8 border border-gray-100/50">
                            <div class="mb-6">
                                <div
                            ...
                            <div
                                class="text-8xl font-mono font-bold bg-gradient-to-r from-gray-900 via-indigo-900 to-purple-900 bg-clip-text text-transparent mb-4 tracking-tight"
                                id="digitalClock">
                                2:30:45
                            </div>
                            <div class="text-xl text-gray-600 font-semibold">Live Time</div>
                        </div>
                        <div class="mb-10">
                            <div
                                class="bg-gradient-to-br from-gray-900/5 to-indigo-900/10 rounded-3xl p-6 shadow-2xl border border-gray-100/50">
                                <div class="relative group">
                                    <video
                                        id="cameraPreview"
                                        class="w-full h-80 object-cover rounded-2xl shadow-2xl border-4 border-white/50"
                                        autoplay
                                        playsinline></video>
                                    <canvas
                                        id="photoCanvas"
                                        class="w-full h-80 object-cover rounded-2xl hidden absolute top-0 left-0 shadow-2xl border-4 border-white/50"></canvas>
                                    <div
                                        class="absolute inset-0 rounded-2xl ring-1 ring-black/5 pointer-events-none"></div>
                                    <div class="absolute bottom-4 left-4 right-4">
                                        <div
                                            class="bg-black/40 backdrop-blur-md rounded-2xl px-4 py-3">
                                            <div class="flex items-center justify-center space-x-3">
                                                <div
                                                    class="w-3 h-3 bg-green-400 rounded-full animate-pulse shadow-lg"></div>
                                                <span class="text-white text-sm font-bold">Camera Active</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="flex space-x-8 mb-12">
                            <button
                                id="timeInBtn"
                                class="group flex-1 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white font-bold py-6 px-10 !rounded-button transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-1 shadow-2xl hover:shadow-3xl whitespace-nowrap relative overflow-hidden">
                                <div
                                    class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                <div
                                    class="flex items-center justify-center space-x-4 relative z-10">
                                    <div
                                        class="w-8 h-8 flex items-center justify-center bg-white/20 rounded-xl shadow-lg">
                            ...
                            <button
                                id="timeOutBtn"
                                class="group flex-1 bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white font-bold py-6 px-10 !rounded-button transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-1 shadow-2xl hover:shadow-3xl whitespace-nowrap disabled:opacity-40 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-lg relative overflow-hidden"
                                disabled>
                                <div
                                    class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                <div
                        ...
                        <div
                            class="bg-gradient-to-br from-gray-50 to-orange-50/30 rounded-3xl p-8 border border-gray-100/50 shadow-2xl mb-8">
                            <div class="flex items-center justify-between mb-8">
                                <h3
                                    class="text-3xl font-bold text-gray-900 flex items-center space-x-4">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-orange-500 to-amber-600 rounded-2xl flex items-center justify-center shadow-xl">
                                ...
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="w-3 h-3 bg-orange-500 rounded-full animate-pulse shadow-lg"></div>
                                    <span class="text-base font-bold text-orange-700">Real-time Tracking</span>
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div
                                    class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100/50 shadow-lg hover:shadow-xl transition-shadow">
                                    <div class="flex items-center justify-between mb-4">
                                        ...
                                        <div
                                            class="w-2 h-2 bg-blue-500 rounded-full shadow-lg"></div>
                                    </div>
                                    <div class="space-y-3">
                                        <div class="text-center">
                                            <div
                                                class="text-4xl font-bold text-blue-900 mb-2"
                                                id="dailyHours">
                                                0h 0m
                                            </div>
                                        ...
                                        <div
                                            class="bg-white/70 rounded-xl p-3 border border-blue-100/50">
                                ...
                                <div
                                    class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100/50 shadow-lg hover:shadow-xl transition-shadow">
                                    <div class="flex items-center justify-between mb-4">
                                        <div class="flex items-center space-x-3">
                                            <div
                                                class="w-8 h-8 bg-green-100 rounded-xl flex items-center justify-center">
                                                <div class="w-4 h-4 flex items-center justify-center">
                                        ...
                                        <div
                                            class="w-2 h-2 bg-green-500 rounded-full shadow-lg"></div>
                                    </div>
                                    <div class="space-y-3">
                                        <div class="text-center">
                                            <div
                                        ...
                                        <div
                                            class="bg-white/70 rounded-xl p-3 border border-green-100/50">
                                            <div class="flex justify-between items-center text-sm">
                                                <span class="text-gray-700 font-medium">Target</span>
                                ...
                                <div
                                    class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-100/50 shadow-lg hover:shadow-xl transition-shadow">
                                    <div class="flex items-center justify-between mb-4">
                                        <div class="flex items-center space-x-3">
                                            <div
                                                class="w-8 h-8 bg-purple-100 rounded-xl flex items-center justify-center">
                                                <div class="w-4 h-4 flex items-center justify-center">
                                        ...
                                        <div
                                            class="w-2 h-2 bg-purple-500 rounded-full shadow-lg"></div>
                                    </div>
                                    <div class="space-y-3">
                                        <div class="text-center">
                                            <div
                                                class="text-4xl font-bold text-purple-900 mb-2"
                                                id="monthlyHours">
                                                138h 20m
                                            </div>
                                        ...
                                        <div
                                            class="bg-white/70 rounded-xl p-3 border border-purple-100/50">
                                            <div class="flex justify-between items-center text-sm">
                                                <span class="text-gray-700 font-medium">Target</span>
                            ...
                            <div
                                class="mt-6 bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl p-6 border border-orange-100/50 shadow-lg">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-4">
                                        <div
                                            class="w-8 h-8 bg-orange-100 rounded-xl flex items-center justify-center">
                                            <div class="w-4 h-4 flex items-center justify-center">
                        ...
                        <div
                            class="bg-gradient-to-br from-gray-50 to-blue-50/30 rounded-3xl p-8 border border-gray-100/50 shadow-2xl">
                            <div class="flex items-center justify-between mb-8">
                                <h3
                                    class="text-3xl font-bold text-gray-900 flex items-center space-x-4">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-xl">
                                        <div class="w-5 h-5 flex items-center justify-center">
                                ...
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="w-3 h-3 bg-blue-500 rounded-full animate-bounce shadow-lg"></div>
                                    <span class="text-base font-bold text-gray-700">Live Updates</span>
                                </div>
                            </div>
                            <div
                                class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-6 mb-8 border border-blue-100/50 shadow-lg">
                                <div class="flex items-center space-x-4 mb-4">
                                    <div
                                        class="w-4 h-4 bg-blue-500 rounded-full shadow-lg"></div>
                                    <span class="text-base font-bold text-blue-900">Latest Activity</span>
                                </div>
                                <p class="text-gray-800 font-bold text-xl" id="lastAction">
                                    No recent activity
                                </p>
                            </div>
                            <div id="actionHistory" class="space-y-4">
                                ...
                                <div class="space-y-4" id="actionHistoryList">
                                    <div
                                        class="flex items-center space-x-4 p-4 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                                        <div
                                            class="w-14 h-14 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl overflow-hidden flex-shrink-0">
                                            <div
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center justify-between mb-2">
                                                ...
                                                <span
                                                    class="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-md">July 31, 2025 11:30 AM</span>
                                            </div>
                                            <p class="text-xs text-gray-500">
                                                No photo captured • Session ended
                                            </p>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center justify-between mb-2">
                                                ...
                                                <span
                                                    class="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-md">July 31, 2025 8:00 AM</span>
                                            </div>
                                            <p class="text-xs text-gray-500">
                                                No photo captured • Location verified
                                            </p>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center justify-between mb-2">
                                                <span class="text-sm font-semibold text-gray-900">Clocked Out</span>
                                                <span
                                                    class="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-md">July 30, 2025 6:00 PM</span>
                                            </div>
                                            <p class="text-xs text-gray-500">
                                                No photo captured • Day completed
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
                <div
                    class="bg-gradient-to-br from-gray-50 to-purple-50/30 rounded-3xl p-8 border border-gray-100/50 shadow-2xl">
                    <div class="flex items-center justify-between mb-8">
                        <h3
                            class="text-3xl font-bold text-gray-900 flex items-center space-x-4">
                            <div
                                class="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl flex items-center justify-center shadow-xl">
                                <div class="w-5 h-5 flex items-center justify-center">
                        ...
                        <div class="flex items-center space-x-2">
                            <div
                                class="w-2 h-2 bg-green-500 rounded-full animate-pulse shadow-lg"></div>
                            <span class="text-sm font-medium text-green-600">Connected</span>
                        </div>
                    </div>
                    <div class="space-y-6">
                        <div
                            class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-100/50 shadow-lg">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="text-sm text-gray-600 font-mono bg-white px-3 py-1 rounded-lg"
                                        id="ipAddress">Detecting...</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm font-medium text-gray-700">Session ID</span>
                                    <span
                                        class="text-sm text-gray-600 font-mono bg-white px-3 py-1 rounded-lg"
                                        id="sessionId">Generating...</span>
                                </div>
                            </div>
                        </div>
                        <div
                            class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100/50">
                            <div class="space-y-4">
                                <div
                ...
                <div
                    class="bg-gradient-to-br from-gray-50 to-green-50/30 rounded-3xl p-8 border border-gray-100/50 shadow-2xl">
                    <div class="flex items-center justify-between mb-8">
                        <h3
                            class="text-3xl font-bold text-gray-900 flex items-center space-x-4">
                            <div
                                class="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center shadow-xl">
                                <div class="w-5 h-5 flex items-center justify-center">
                        ...
                        <div class="flex items-center space-x-3">
                            <div
                                class="w-3 h-3 rounded-full shadow-lg pulse-animation"
                                id="gpsStatus"></div>
                    ...
                    <div class="space-y-6">
                        <div
                            class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100/50 shadow-lg">
                            <div class="flex items-center space-x-3 mb-4">
                                <div
                                    class="w-8 h-8 bg-green-100 rounded-xl flex items-center justify-center">
                                    <div class="w-4 h-4 flex items-center justify-center">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center">
                                    <span
                                        ...
                                        id="latitudeDisplay">Latitude: Detecting...</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span
                                        class="text-sm font-medium text-gray-700"
                                        id="longitudeDisplay">Longitude: Detecting...</span>
                                </div>
                                <div class="flex justify-between items-center">
                        ...
                        <div
                            ...
                            <div
                                class="mt-6 p-4 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl border border-gray-100">
